      ...
      {isLoading ? (
        ...
        <div className="relative group w-full h-full flex items-center justify-center">
          ...
          <a
            ...
            className="absolute bottom-4 right-4 bg-indigo-600 text-white p-3 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 transform group-hover:scale-100 scale-90 hover:bg-indigo-700"
